...
window.onload = function(){ 
   var base_path=''
    $.getScript(base_path+"js/slick.js", function() {
    // Optional callback if you need something after recaptcha loads
    });
    $.getScript(base_path+"js/bootstrap.bundle.min.js", function() {
    // Optional callback if you need something after recaptcha loads
    });
    setTimeout(() => {
         $.getScript(base_path+"js/custom.js", function() {
            // Optional callback after custom.js loads
        });
