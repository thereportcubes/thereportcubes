...
class RequestExport implements FromCollection , WithHeadings
{
    ...
    */
    ...
    {
        return Sample_Request::where('report_type_request','Request Customization')->select('full_name','company_name','degingnation','busniess_email','contact_number','country','message','email_from','email_to','report_title','created_date_time')->get();
    }
