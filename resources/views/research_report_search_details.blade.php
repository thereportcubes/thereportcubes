...
<section class="mini-banner">
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               <h1 class="mb-0 mini-banner-title">Research reports single</h1>
            </div>
         </div>
      </div>
   </section>
            ...
            <div class="col-md-3 sm-100 ">
               <div class="right-sidebar when-scroll">
                  ...
                  <div class="btn-groups">
                     <a href="#" class="btn btn-primary small-btn d-inline-block max-100 color-one"><i
                           class="fa fa-hand-pointer" aria-hidden="true"></i>
                        Request
                        Sample</a>
                     <a href="" class="btn btn-primary small-btn d-inline-block max-100 color-two"><i
                           class="fa fa-hand-pointer" aria-hidden="true"></i> Talk to our Consultant</a>
                     <a href="#" class="btn btn-primary small-btn d-inline-block max-100 color-three"><i
