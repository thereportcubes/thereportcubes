               ...
               <div class="ml-auto d-flex align-items-center">
                  <nav>
                     <ol class="breadcrumb p-0 m-b-0">
                        ...
                        <li class="breadcrumb-item active text-primary" aria-current="page">Edit Refund Policy</li>
                     </ol>
                  </nav>
               </div>
            </div>
         ...
         <div class="col-xl-12">
            <div class="card card-statistics">
               ...
               <div class="card-body">
                  ...
                  <br>
                  @endif
                  <form action="{{url('TRC/11/update_refund')}}/{{request()->segment(4)}}" method="post" enctype="multipart/form-data">
                     @csrf
                     <div class="form-row">
