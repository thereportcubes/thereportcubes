               ...
               <div class="ml-auto d-flex align-items-center">
                  <nav>
                     <ol class="breadcrumb p-0 m-b-0">
                        ...
                        <li class="breadcrumb-item active text-primary" aria-current="page">Edit Privacy Policy</li>
                     </ol>
                  </nav>
               </div>
            </div>
         ...
         <div class="col-xl-12">
            <div class="card card-statistics">
               ...
               <div class="card-body">
                  ...
                  <br>
                  @endif
                  <form action="{{url('TRC/11/update_privacy')}}/{{request()->segment(4)}}" method="post" enctype="multipart/form-data">
                     @csrf
                     <div class="form-row">
                        <div class="form-group col-md-12">
                           <label for="title">Heading</label>
                           <input type="text" name="heading" value="{{$list->heading}}" placeholder="Heading" class="form-control" required="required"  id="title">
                        </div>
                        <div class="form-group col-md-12">
                           <label for="description">Description</label>
                           <textarea name="Description">{{$list->content}}</textarea>
                        </div>
