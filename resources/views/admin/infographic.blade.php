                    ...
                    <div class="card-header">
                        <div class="card-heading">
                            <div class="row">
                                ...
                                <div class="col-md-2 text-right"><a href=" {{route('TRC/11/infographic_list')}}"><button type="button" class="btn btn-info ">All Infographic</button></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        @endif
                        <form action=" {{route('TRC/11/save_infographic')}}" method="post" id="myForm" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                           ...
                           <label for="inputPassword4">Image</label>
                             <input type="file" name="infographic_img" class="form-control" id="inputPassword4" required>
                               </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="report_link"  placeholder="Summary Report Link" class="form-control" id="Summary Report Link" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="page">Infographic Url</label>
                                    <input type="text" name="slug"  placeholder="Infographic Url" class="form-control" id="Inforaphic Url" required>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea name="seo_description" rows="4" cols="50" class="form-control" required></textarea>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="page">Seo Key Words</label>
                                    <textarea name="seo_keyword" rows = "4" cols="50" class="form-control" required></textarea>
                                </div>
