               ...
               <div class="ml-auto d-flex align-items-center">
                  <nav>
                     <ol class="breadcrumb p-0 m-b-0">
                        ...
                        <li class="breadcrumb-item active text-primary" aria-current="page"> Edit Industries</li>
                     </ol>
                  </nav>
               </div>
            </div>
         ...
         <div class="col-xl-12">
            <div class="card card-statistics">
               ...
               <div class="card-body">
                  ...
                  <br>
                  @endif
                  <form action="{{url('TRC/11/update_industries')}}/{{request()->segment(4)}}" method="post" enctype="multipart/form-data">
                     @csrf
                     <div class="form-row">
                        <div class="form-group col-md-12">
                           <label for="page">Enter Category Url</label>
                           <input type="text" name="category_url" id = "category_url" value="{{$list->category_url}}" class="form-control">
                        </div>
                        <div class="form-group col-md-12">
                           <label for="page">Enter Category Name</label>
                           <input type="text" name="cat_name" placeholder = 'Enter Category Name' id = "cat_name" value="{{$list->cat_name}}" class="form-control">
                        </div>
                        <div class="form-group col-md-12">
                        ...
                        <div class="form-group col-md-12">
                           ...
                           <input type="hidden" name="page_type" class="form-control" id="page_type" value="{{$seo_content->seo_title}}">
                        </div>
                        <div class="form-group col-md-12">
