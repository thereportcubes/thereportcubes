   ...
   <div class="container-fluid">
               ...
               <div class="ml-auto d-flex align-items-center">
                  <nav>
                     <ol class="breadcrumb p-0 m-b-0">
                        ...
                        <li class="breadcrumb-item active text-primary" aria-current="page">All Infographics Enquiry</li>
                     </ol>
                  </nav>
               </div>
            </div>
      ...
      <div class="row">
         <div class="col-lg-12">
            ...
            <form action="{{route('filter_infographics_enq')}}" method="get" enctype="multipart/form-data">
               <div class="card-body">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-md-3 text-right">
                           <div id = "export-data" style="margin-top:8px;" ><br>
                              ...
                              <a href="{{route('infographics_enq_export')}}"><button type="submit" class="btn btn-primary" id = "export-csv" name = "export-csv">Export CSV</button>
                           </div>
                        </div>
                        <!-- <div class="form-group col-md-3 text-right">
                           <div id = "export-data" style="margin-top:8px;"><br>
