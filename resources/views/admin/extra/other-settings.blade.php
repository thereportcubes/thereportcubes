                    ...
                    <div class="ml-auto d-flex align-items-center">
                        <nav>
                            <ol class="breadcrumb p-0 m-b-0">
                                ...
                                <li class="breadcrumb-item active text-primary" aria-current="page">Other Settings</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        @csrf
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="phone" class="form-control" id="inputPassword4" placeholder="Enter your mobile no" required >
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">Email</label>
                                    <input type="email" name="email" class="form-control" id="inputEmail4" placeholder="Enter your email no" ">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">DOB</label>
                                    <input type="date" name="dob" class="form-control" id="inputPassword4" placeholder="Enter your dob">
                                </div>
                                <div class="form-group col-md-6">
