...
@section('title','Member Wallet Details')
@section('content')
                              ...
                              <div class="ml-auto d-flex align-items-center">
                                 <nav>
                                    <ol class="breadcrumb p-0 m-b-0">
                                       ...
                                       <li class="breadcrumb-item active text-primary" aria-current="page">Member Wallet</li>
                                    </ol>
                                 </nav>
                              </div>
                           </div>
                        ...
                        <div class="col-xxl-9 m-b-30">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="col-md-6">
                                                ...
                                                <div class="card-header">
                                                    <h4 class="card-title">Member Wallet</h4>
                                                </div>
                                                <div class="cards">
                                                    <div class="card-body">
                        ...
                        <div class="col-xxl-9 m-b-30">
                           <div class="card">
                              <div class="card-header d-flex justify-content-between align-items-center">
                                 <h4 class="header-title mb-0">Transaction List ({{$list->name}})</h4>
                              </div>
