                    ...
                    <div class="ml-auto d-flex align-items-center">
                        <nav>
                            <ol class="breadcrumb p-0 m-b-0">
                                ...
                                <li class="breadcrumb-item active text-primary" aria-current="page">Edit Sub Admin</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card card-statistics">
                    ...
                    @endif
                    <br>
                    <form action="{{url('TRC/11/edit-sub-admin')}}/{{$id}}" method="post">
                        ...
                        @csrf
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="phone" class="form-control" id="inputPassword4" placeholder="Enter your mobile no" required value="{{$user->phone}}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">Email</label>
                                    <input type="email" name="email" class="form-control" id="inputEmail4" placeholder="Enter your email no" value="{{$user->email}}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">DOB</label>
                                    <input type="date" name="dob" class="form-control" id="inputPassword4" placeholder="Enter your dob" value="{{$user->dob}}">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <input type="text" name="address" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" value="{{$user->address}}">
                                </div>
