               ...
               <div class="ml-auto d-flex align-items-center">
                  <nav>
                     <ol class="breadcrumb p-0 m-b-0">
                        ...
                        <li class="breadcrumb-item active text-primary" aria-current="page"> Edit Region</li>
                     </ol>
                  </nav>
               </div>
            </div>
         ...
         <div class="col-xl-12">
            <div class="card card-statistics">
               ...
               <div class="card-body">
                  ...
                  <br>
                  @endif
                  <form action="{{url('TRC/11/update_region')}}/{{request()->segment(4)}}" method="post" enctype="multipart/form-data">
                     @csrf
                     <div class="form-row">
                        <div class="form-group col-md-6">
                           <label for="page">Region Url</label>
                           <input type="text" name="page_url" id = "page_url" class="form-control" value="{{$data->page_url}}">
                        </div>
                        <div class="form-group col-md-6">
                           <label for="page">Region Name</label>
                           <input type="text" name="region_name"  id = "region_name" class="form-control" required value="{{$data->region_name}}">
                        </div> 
