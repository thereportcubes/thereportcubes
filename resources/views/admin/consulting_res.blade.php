...
@section('title','Consulting Research')
@section('content')
               ...
               <div class="ml-auto d-flex align-items-center">
                  <nav>
                     <ol class="breadcrumb p-0 m-b-0">
                        ...
                        <li class="breadcrumb-item active text-primary" aria-current="page">Consulting Research</li>
                     </ol>
                  </nav>
               </div>
            </div>
         ...
         <div class="col-lg-12">
            <div class="card card-statistics">
               ...
               <div class="card-body">
                  ...
                  <form action="{{route('filter_consulting')}}" method="get" enctype="multipart/form-data">
                     <div class="row">
                        ...
                        <div class="form-group col-md-2 text-right">
                           <div id = "export-data" style="margin-top:8px;" ><br>
                              ...
                              <a href="{{route('consulting_export')}}"><button type="button" class="btn btn-primary" id = "export-csv" name = "export-csv">Export CSV</button></a>
                           </div>
                        </div>
