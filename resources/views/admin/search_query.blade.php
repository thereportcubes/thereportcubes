   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-lg-12">
            ...
            <form action="{{route('filter_search')}}" method="get" enctype="multipart/form-data">
               <div class="card-body">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-md-3 text-right">
                           <div id = "export-data" style="margin-top:8px;" ><br>
                              ...
                              <a href="{{route('search_export')}}"><button type="submit" class="btn btn-primary" id = "export-csv" name = "export-csv">Export CSV</button>
                           </div>
                        </div>
                        <!-- <div class="form-group col-md-3 text-right">
                           <div id = "export-data" style="margin-top:8px;"><br>
