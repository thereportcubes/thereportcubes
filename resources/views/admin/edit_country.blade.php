               ...
               <div class="ml-auto d-flex align-items-center">
                  <nav>
                     <ol class="breadcrumb p-0 m-b-0">
                        ...
                        <li class="breadcrumb-item active text-primary" aria-current="page"> Edit Country</li>
                     </ol>
                  </nav>
               </div>
            </div>
         ...
         <div class="col-xl-12">
            <div class="card card-statistics">
               ...
               <div class="card-body">
                  ...
                  <br>
                  @endif
                  <form action="{{url('TRC/11/update_country')}}/{{request()->segment(4)}}" method="post" enctype="multipart/form-data">
                     @csrf
                     <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                           ...
                           <input type="text" class="form-control" id="country_name" name = "country_name" required value="{{$data->country_name}}">
                        </div>
                        <div class="form-group col-md-12">
                           <label>Country Url</label>
                           <input type="text" class="form-control" id="country_url" name = "country_url" required value="{{$data->page_url}}">
                        </div>
                         <div class="form-group col-md-12">
