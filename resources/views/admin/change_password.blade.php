      ...
      <div class="col-xl-12">
         <div class="card card-statistics">
            ...
            <div class="card-body">
               ...
               <br>
               @endif
               <form action=" {{route('TRC/11/submitResetPasswordForm')}}" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="form-row">
                     ...
                     <div class="form-group">
                        <label></label>
                        <button type="submit" name = "add" id = "add" class="btn btn-warning">change <i class="glyphicon glyphicon-send"></i></button>
                     </div>
