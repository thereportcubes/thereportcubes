...
@section('title','All Request Sample')
@section('content')
               ...
               <div class="ml-auto d-flex align-items-center">
                  <nav>
                     <ol class="breadcrumb p-0 m-b-0">
                        ...
                        <li class="breadcrumb-item active text-primary" aria-current="page">Sample Request</li>
                     </ol>
                  </nav>
               </div>
            </div>
         ...
         <div class="col-lg-12">
            <div class="card card-statistics">
               <div class="card-body">
                  ...
                  <form action="{{route('filter_sample')}}" method="get" enctype="multipart/form-data">
                     <div class="row">
                        ...
                        <div class="form-group col-md-2 text-right">
                           <div id = "export-data" style="margin-top:8px;" ><br>
                              ...
                              <a href="{{route('sample-export')}}"><button type="button" class="btn btn-primary" id = "export-csv" name = "export-csv">Export CSV</button></a>
                           </div>
                        </div>
                  ...
                  <table id="datatable" class="display compact table table-striped table-bordered">
                    ...
                    <!--<th>Action</th>--> 
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td class="p-1">{{++$key}}</td>
                          <td>{{ \Carbon\Carbon::parse($data->created_date_time)->format('Y-m-d') }}</td>
