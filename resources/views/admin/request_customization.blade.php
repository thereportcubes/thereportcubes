...
@section('title','Request Customization')
@section('content')
               ...
               <div class="ml-auto d-flex align-items-center">
                  <nav>
                     <ol class="breadcrumb p-0 m-b-0">
                        ...
                        <li class="breadcrumb-item active text-primary" aria-current="page">Request Customization</li>
                     </ol>
                  </nav>
               </div>
            </div>
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-md-3 text-right">
                           <div id = "export-data" style="margin-top:8px;" ><br>
                              ...
                              <a href="{{route('request_export')}}"><button type="submit" class="btn btn-primary" id = "export-csv" name = "export-csv">Export CSV</button>
                           </div>
                        </div>
                        <!-- <div class="form-group col-md-3 text-right">
                           <div id = "export-data" style="margin-top:8px;"><br>
