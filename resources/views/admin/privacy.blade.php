               ...
               <div class="ml-auto d-flex align-items-center">
                  <nav>
                     <ol class="breadcrumb p-0 m-b-0">
                        ...
                        <li class="breadcrumb-item active text-primary" aria-current="page"> Add New Privacy Policy</li>
                     </ol>
                  </nav>
               </div>
            </div>
            ...
            <div class="card card-statistics">
               <div class="card-header">
                  <div class="card-heading">
                     <div class="row">
                        <div class="col-md-10">
                           <h4 class="card-title">Add New Privacy Policy</h4>
                        </div>
               ...
               <div class="card-body">
                  ...
                  <br>
                  @endif
                  <form action=" {{route('TRC/11/save_privacy')}}" method="post" enctype="multipart/form-data">
                     @csrf
                     <div class="form-row">
                        <div class="form-group col-md-12">
                           <label for="title">Heading</label>
                           <input type="text" name="heading" value="" placeholder="Heading" class="form-control" required="required"  id="title">
                        </div>
                        <div class="form-group col-md-12">
