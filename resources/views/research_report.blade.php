    ...
    <div class="row">
      <div class="col-md-3 sm-100">
        ...
        <div class="filter when-scroll ">
          <h2 style="font-size: 18px; padding-bottom: 15px; font-weight:bold; color: var(--primary-color);">Target Industries
          </h2>
      ...
      <div class="col-md-9">
        <div class="relatedProductsList box-shadow">
          ...
          <ul class="pagination clearfix" id="paginationBottom">
            <li class="page-count"><strong><span>{{count($data)}}</span> Results</strong> (Page 1 of {{
              ceil(count($data)/10)}} ) </li>
