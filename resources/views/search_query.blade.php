      ...
      <div class="row">
         <div class="col-md-9 sm-100">
            <div class="box-shadow">
               <h6 class="fw-600 red-title-bg ps-4">Search Result For: {{$search_keyword}}</h6>
               ...
               <div class="tab-content" id="myTabContent">
                     ...
                     <div class="p-4">
                        ...
                        <div class="row" style="align-items: center;">
                          ...
                          <div class="col-md-9">
                          <input class="ab-input" type="email" name="buss_email" value="{{ old('buss_email') }}"placeholder="Enter your Bussiness Email" required>
                        </div>
                        </div>
...
<script src="{{asset('assets/js/vendors.js')}}"></script>
	...
	<script type="text/javascript">
      let base_url_search = {!! json_encode(url('/')) !!};
