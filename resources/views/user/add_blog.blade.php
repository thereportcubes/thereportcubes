                    ...
                    <div class="card-header">
                        <div class="card-heading">
                            <div class="row">
                                ...
                                <div class="col-md-2 text-right"><a href="{{route('user/blog_list')}}"><button type="button" class="btn btn-info ">All Blogs</button></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('user/save_blog')}}" method="post" id="myForm" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
