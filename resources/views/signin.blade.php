                  ...
                  <div class="col-md-12">
                     <div class="cart-borders">
                        ...
                        <div class="signin" style="display: @if(Route::current()->getName() == 'signup') none @endif">
                           ...
                           <form method="post" action="{{ route('signin') }}" id="signForm">
                              @csrf
                           ...
                           <form method="post" action="{{ route('signup') }}">
                              @csrf
                                 ...
                                 <div class="row" style="align-items: center;">
                                    ...
                                    <div class="col-md-9">
                                       <input class="ab-input" type="text" name="first_name" value="{{ old('first_name') }}" placeholder="Enter your Full name" required>
                                    </div>
                                 </div>
                                 <div class="row" style="align-items: center;">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                       <input class="ab-input" type="text" name="company_name" value="{{ old('company_name') }}" placeholder="Enter your Company Name" required>
                                    </div>
                                 </div>
                                 <div class="row" style="align-items: center;">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                       <input type="email" class="ab-input" name="email"  value="{{ old('email') }}" placeholder="Email Address" />
                                    </div>
                                 </div>
                                 ...
                                 <div class="row" style="align-items: center;">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <select class="ab-input" id="country" name="country" placeholder="Select Country">
...
<option value="Kosovo +(383)">Kosovo +(383)</option>
                                 ...
                                 <div class="row" style="align-items: center;">
                                    ...
                                    <div class="col-md-9">
                                       <input class="ab-input" type="text" name="phone_number" value="{{ old('phone_number') }}" placeholder="Enter Your Contact Number" required>
                                    </div>
                                 </div>
                                  ...
                                  <div class="row" style="align-items: center;">
                                    ...
                                    <div class="col-md-9">
                                     <input type="password" class="ab-input" name="password"  value="{{ old('email') }}" placeholder="Create Password"/>
                                    </div>
                                 </div>
                                  <div class="row" style="align-items: center;">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                     <input type="password" class="ab-input" name="password_confirmation"  value="{{ old('email') }}"  placeholder="Confirm Password" />
                                    </div>
                                 </div>
                                    <div class="row" style="align-items: center;">
                                    <div class="col-md-12">
