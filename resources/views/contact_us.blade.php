            ...
            <div class="ab-col col-md-8 " style="text-align: left;">
               ...
               <form action="{{route('save_contact')}}" class="ab-contact-form"  method="post" novalidate="novalidate">
                  ...
                  <div class="row" style="align-items: center;">
                     ...
                     <div class="col-md-9">
                        <!-- <input class="ab-input"  name="country_name" type="tel"  value="{{ old('country_name') }}" placeholder="Enter Your Country" required> -->
...
<option value="Kosovo +(383)">Kosovo +(383)</option>
                  ...
                  <div class="row" style="align-items: center;">
                     ...
                     <div class="col-md-9">
                        <input class="ab-input" id=""  name="phone" type="tel"  value="{{ old('phone') }}"  maxlength="13" placeholder="Enter Your Phone Number" required>
                     </div>
                  </div>
...
></div>
            ...
            <div class="ab-col col-md-4 " style="text-align: left;">
               ...
               <div class="offic-div">
                  ...
                  <p class="address-p"> Burjuman Business Tower, Burjuman, Dubai</p>
