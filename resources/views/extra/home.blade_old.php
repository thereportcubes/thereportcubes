...
@section('content')
         ...
         <div class="banner-with-text">
            ...
            <div class="pull-up-text">
               <div class="banner-content">
                  ...
                  <h1 class="banner-title mb-4">{{$data->banner_desc}}</p>
   ...
   <section class="upcomming-report bottom-space">
      <div class="container">
               ...
               <a href="" class="black">
                  <div class="report-box">
                     ...
                     <div class="report-content">
                        <p class="report-title mb-2">Southeast Asia Ceramic Tiles Market ...</p>
                        <div class="report-date-page d-flex align-items-center justify-content-between ">
                           <p><i class="fa fa-calendar" aria-hidden="true"></i><span> Sep 2023</span></p>
                           <p>Pages 135</p>
                        </div>
                     </div>
                  </div>
         ...
         <div class="row pt-4">
            <div class="col-md-12 text-center">
               <a href="" class="btn btn-primary banner-btn" tabindex="-1">Load More</a>
            </div>
         </div>
      </div>
   </section>
