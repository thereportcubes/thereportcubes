               ...
               <div class="box-shadow">
                  <ul class="nav nav-tabs tab-area when-scroll" id="myTab" role="tablist">
                    ...
                    <button class="nav-link active" id="Request-tab" data-bs-toggle="tab" data-bs-target="#Request"
                           type="button" role="tab" aria-controls="Request" aria-selected="false">Talk To Our Consultant</button> 
                     </li>
                  </ul>
                  <div class="tab-content" id="myTabContent">
                     <div class="tab-pane fade" id="Overview" role="tabpanel"
                        ...
                        <div class="tabs-content">
                           ...
                           <p>In addition to this, in 2020, China conducted its first in-orbit 3D printing test, which
                              ...
                              (SLA), Selective Laser Sintering (SLS), etc.</p>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>Honeywell International Inc., SSI Schaefer, Omron Corporation, Schneider
                                          ...
                                          Autotech, Diafuku, Swisslog, Other</td>
                                    </tr>
                                    <tr>
                     ...
                     <div class="p-4">
                        ...
                        <br>
                        @endif
                        <form action="{{ url('save-request-sample') }}" method="post">
                           @csrf
                           ...
                           <div class="mb-3">
                              ...
                              <input type="text" name="contact_number" class="form-control" id="phone_code" placeholder="Phone Number" required>
                           </div>
                           <div class="mb-3">
            ...
            <div class="col-md-3 sm-100 ">
               <div class="right-sidebar when-scroll">
                  ...
                  <div class="btn-groups">
                     <a href="{{ url('query/request-sample') }}" class="btn btn-primary small-btn d-inline-block color-one"><i
                           class="fa fa-hand-pointer" aria-hidden="true"></i>
                        Request
                        Sample</a>

                     <a href="{{ url('query/talk-to-consultant') }}" class="btn btn-primary small-btn d-inline-block color-two"><i class="fa fa-hand-pointer"
                           aria-hidden="true"></i> Talk to our Consultant</a>

                     <a href="{{ url('query/request-customization') }}" class="btn btn-primary small-btn d-inline-block color-three"><i
                  ...
                  <div class="box-shadow">
                     ...
                     <ul class="mb-0 ps-0">
                        <li class="list-unstyled fs-14"><a href=""><i class="fa fa-handshake" aria-hidden="true"></i>
                              Global Aviation Actuator Market Research
                              Report: Forecast (2022-2027)</a></li>
                        <li class="list-unstyled fs-14"><a href=""><i class="fa fa-handshake" aria-hidden="true"></i>
                              Global Aviation Actuator Market Research
                              Report: Forecast (2022-2027)</a></li>
                     </ul>
